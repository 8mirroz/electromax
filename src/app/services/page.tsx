          ...
          <div className="rounded-3xl border border-border bg-muted/30 p-8 md:p-10">
            <div className="grid gap-6 md:grid-cols-[1.3fr_1fr] md:items-center">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/contacts"
                  className="inline-flex h-11 items-center justify-center rounded-full bg-primary px-6 text-sm font-bold text-white shadow-md transition hover:bg-primary/90"
                >
                  Связаться
                </Link>
                <Link
                  href="/projects"
                  className="inline-flex h-11 items-center justify-center rounded-full border border-border px-6 text-sm font-bold text-foreground transition hover:border-primary/60"
                >
                  Смотреть проекты
                </Link>
              </div>
