        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                Пользователь обязуется не нарушать работоспособность сайта и не использовать его во
                вред третьим лицам.
              </li>
              <li>
          ...
          <div className="space-y-3">
            ...
            <p>
              ...
              условия определяются в коммерческом предложении после уточнения задачи и обследования
              объекта.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p>
              Все тексты, изображения, схемы и элементы дизайна являются объектами авторского права.
              Копирование допускается только с письменного разрешения Компании.
            </p>
          </div>
