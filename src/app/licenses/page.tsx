...
const docs: LicenseDoc[] = [
  {
    ...
    validUntil: "до 2029",
    scope:
      "Работы по монтажу, техническому обслуживанию и ремонту средств обеспечения пожарной безопасности зданий и сооружений.",
  ...
  },
  {
    ...
    scope:
      "Выполнение проектных и строительно-монтажных работ в рамках допусков и регламентов саморегулируемой организации.",
  ...
  },
  {
    ...
    validUntil: "до 2027",
    scope:
      "Система менеджмента качества для процессов проектирования, реализации и сопровождения инженерных решений.",
      ...
      <section className="pt-28 pb-12 md:pt-32 md:pb-20 bg-muted/20 border-b border-border">
        <div className="container mx-auto max-w-7xl">
          <div className="space-y-6">
            <Badge icon={FileCheck} className="mb-6">
              Лицензии и допуски
            </Badge>
            ...
            <p className="text-xl text-muted-foreground leading-relaxed font-medium">
              На этой странице собраны ключевые документы, которые чаще всего требуются заказчикам,
              службе безопасности, внутреннему аудиту и закупочным подразделениям. По запросу
              предоставляем расширенный пакет сведений для тендеров и согласований.
            </p>
          </div>
        </div>
      </section>
                ...
                {docs.map((doc) => (
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-5">
                      ...
                      <span
                        className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold tracking-tight border ${
                          doc.status === "active"
            ...
            <aside className="lg:col-span-4">
              <div className="sticky top-24 space-y-6">
                ...
                <section className="rounded-[2rem] border border-primary/20 bg-primary/5 p-6">
                  <div className="text-[10px] font-bold tracking-tight text-primary mb-3">
                    Нужны документы под тендер?
                  </div>
