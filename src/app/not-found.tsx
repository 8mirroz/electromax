      ...
      <nav className="bg-background border-b border-border">
        <div className="container mx-auto max-w-7xl h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            <span className="material-icons-outlined text-primary text-2xl group-hover:scale-110 transition-transform">engineering</span>
            <span className="font-display font-bold text-lg tracking-tight text-foreground">ELECTRO<span className="text-primary">MAX</span></span>
          </Link>
          <Link href="/" className="text-xs font-bold text-muted-foreground hover:text-primary uppercase tracking-widest">
            На главную
          </Link>
        </div>
      </nav>
      ...
      <section className="flex-1 flex items-center justify-center py-24">
        <div className="text-center px-6">
          <div className="w-24 h-24 rounded-3xl bg-primary/10 flex items-center justify-center mx-auto mb-8">
            <span className="material-icons-outlined text-primary text-6xl">error_outline</span>
          </div>
          <h1 className="text-9xl font-display font-black text-primary mb-4">
            404
          </h1>
