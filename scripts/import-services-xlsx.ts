...
const SERVICES_DATA: ServiceData[] = [
  ...
  },
  {
    ...
    shortName: "АСУЗ",
    description: "Интеграция всех инженерных систем в единый центр управления.",
    basePrice: "request",
    cta: "Заказать аудит",
    themeColor: "#2563eb",
    icon: "settings",
  },
  {
    ...
    shortName: "ЭО",
    description: "Энергосберегающее освещение с экономией до 40%.",
    basePrice: 900,
  ...
  {
    slug: "eom",
    title: "Электроснабжение и силовые сети",
    shortName: "ЭОМ",
    description: "Проектирование, монтаж и проверка ЭТЛ.",
    basePrice: 1500,
    cta: "Бесплатный выезд",
    themeColor: "#2563eb",
    icon: "bolt",
  },
  {
    ...
    shortName: "ОС",
    description: "Защита периметра и помещений.",
    basePrice: 350,
    cta: "Тест-драйв системы",
    themeColor: "#2563eb",
    icon: "security",
  },
  {
    ...
    shortName: "СКС",
    description: "Кабельная инфраструктура с гарантией 25 лет.",
    basePrice: 3000,
    cta: "Аудит сети",
    themeColor: "#2563eb",
    icon: "hub",
  },
  {
    ...
    shortName: "СКУД",
    description: "Учёт рабочего времени и биометрия.",
    basePrice: 15000,
    cta: "Демо на объекте",
    themeColor: "#2563eb",
    icon: "badge",
  },
  {
    ...
    shortName: "СОТ",
    description: "IP-видеонаблюдение с AI аналитикой.",
    basePrice: 600,
    cta: "Тест камеры",
    themeColor: "#2563eb",
    icon: "videocam",
  },
  {
    ...
    shortName: "СОУЭ",
    description: "Речевое оповещение 1-5 типа.",
    basePrice: 250,
    cta: "Акустический расчёт",
    themeColor: "#2563eb",
    icon: "campaign",
  },
  {
    ...
    shortName: "ТО",
    description: "SLA 24/7 для всех систем.",
    basePrice: 5000,
